        ...
        <section className="hero-section">
          ...
          <div className="container hero-layout">
            <div className="hero-copy">
              ...
              <h1 className={isEnglish ? undefined : 'hero-title-ko'}>{isEnglish ? <>Find patterns in your trades,<br /><span>build your own trading rules.</span></> : <>내 거래에서 패턴을 찾아<br /><span>나만의 매매법을 만드세요</span></>}</h1>
